...
The demonstrated lack of strong information on stock status within catch histories alone means that differences in catch-only model structure and core assumptions between different assessment efforts can produce starkly contrasting conclusions on global stock status, leading to debates that are inconclusive as they are inherently driven by assumptions. The need is to develop better datasets and approaches on the ground that can lead to more conclusive inferences about the state of global unassessed fisheries. The FAO is leading efforts to increase technical capacity and monitoring and evaluation infrastructure to better inform fisheries management in places with limited data. Such projects stand to provide a better picture of fishery status at global and local scales, furthering our ability to meet the UN SDG targets. Our results emphasize the urgency and rationale for building the infrastructure and capacity that can lead to better marine resource management globally . Catch-only methods may be a good starting point when applied properly, but achieving meaningful improvements in the assessment and management of global unassessed fisheries will depend on expanded collection of targeted data types, active management, and local capacity building. 
