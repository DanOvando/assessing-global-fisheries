...
**Authors**:
Daniel Ovando^1^, Ray Hilborn^1^, Cole Monnahan^2^, Merrill Rudd^3^, Rishi Sharma^4^, James Thorson^2^, Yannick Rousseau^5^, Yimin Ye^4^
...
\begin{equation}
  p_t \sim e^{N\left(-\sigma_{proc}^2/2,\sigma_{proc}\right)}
(\#eq:procerror)
\end{equation}
