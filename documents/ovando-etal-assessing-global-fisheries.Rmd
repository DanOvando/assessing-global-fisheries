---
title: |
  | Global Assessments of Fishery Status need 
  | Better Data more than Better Models
author: 
  - Daniel Ovando
  - Ray Hilborn
  - Cole Monnahan
...
: (\#tab:data) Broadly available data used to inform estimates of global stock status
...
dat_description <- tribble(~`Data Name`, ~Description,
        ...
        "cpue", "Fit to CPUE index created from RAM catch and regional effort index. 2.6% technology creep",
        "cpue-plus", "Fit to CPUE index created from RAM catch and regional effort index with priors informed by SAR and FMI. 2.6% tech. creep",
